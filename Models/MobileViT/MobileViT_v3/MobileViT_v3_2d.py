...
from Models.MobileViT.MobileViT_v3.Block.Module.BaseLayers import InvertedResidual, GlobalPool
from Models.MobileViT.MobileViT_v3.Block.MobileViT_v3_Block import MobileViTBlockv3 as Block
...
if __name__ == "__main__":
    model = MobileViT_v3(num_classes=5)
    x = torch.randn(2, 3, 256, 256)
    y = model(x)
    print(y.shape)
    from util.pytorch_vision.plot_torchinfo_summary import summary_info

    summary_info(model, x, depth=2)
